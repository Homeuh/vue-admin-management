...
export default {
    ...
    methods: {
        ...
        async getParamsData () {
            ...
            const res = await axios.request({
                url: `categories/${this.getCateId}/attributes`,
                method: "get",
        ...
        async showEditDialog (attrId) {
            const res = await axios.request({
                url: `categories/${this.getCateId}/attributes/${attrId}`,
                method: "get",
        ...
        editParams () {
            this.$refs.editFromRef.validate(async valid => {
                if (!valid) return
                const res = await axios.request({
                    url: `categories/${this.getCateId}/attributes/${this.editFrom.attr_id}`,
                    method: "put",
                    data: {
        ...
        async saveAttrVals (row) {
            const res = await axios.request({
                url: `categories/${this.getCateId}/attributes/${row.attr_id}`,
                method: "put",
                data: {
